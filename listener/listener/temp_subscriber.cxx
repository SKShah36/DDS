...
class temp_msgListener : public DDSDataReaderListener {
  public:
...
void temp_msgListener::on_data_available(DDSDataReader* reader)
{
    temp_msgDataReader *temp_msg_reader = NULL;
    temp_msgSeq data_seq;
    DDS_SampleInfoSeq info_seq;
    DDS_ReturnCode_t retcode;
    int i;

    temp_msg_reader = temp_msgDataReader::narrow(reader);
    ...
    for (i = 0; i < data_seq.length(); ++i) {
        if (info_seq[i].valid_data) {
            ...
            //temp_msgTypeSupport::print_data(&data_seq[i]);
    ...
    retcode = temp_msg_reader->return_loan(data_seq, info_seq);
    if (retcode != DDS_RETCODE_OK) {
...
extern "C" int subscriber_main(int domainId, int sample_count)
{
    ...
    DDSTopic *topic = NULL;
    temp_msgListener *reader_listener = NULL; 
    ...
    reader_listener = new temp_msgListener();
    ...
    for (count=0; (sample_count == 0) || (count < sample_count); ++count) {
        ...
        printf("temp_msg subscriber sleeping for %d sec...\n",
        receive_period.sec);
