...
extern "C" int subscriber_main(int domainId, int sample_count)
{
	...
	temp_msgDataReader *temp_msgreader= temp_msgDataReader::narrow(reader);
	if (temp_msgreader == NULL) {
	...
	for (int i = 0; i < data_seq.length(); ++i) {
            ...
            //temp_msgTypeSupport::print_data(&data_seq[i]);
            	...
            	temp_msg dummy;
            	retcode = temp_msgreader->get_key_value(dummy, info_seq[i].instance_handle);
            		if (retcode != DDS_RETCODE_OK) {
	...
	retcode = temp_msgreader->return_loan(data_seq, info_seq);
    	if (retcode != DDS_RETCODE_OK) {
